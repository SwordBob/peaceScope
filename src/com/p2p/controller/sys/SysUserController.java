...
public class SysUserController extends p2pBaseController<SysUser> implements Constant {
...
//===============
	...
	public void getSysUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<SysUser> sysUserList = sysUserService.getSysUserList(queryResult.getResultList());
		ListView<SysUser> sysUserListView = new ListView<SysUser>();
		sysUserListView.setData(sysUserList);
		sysUserListView.setTotalRecord(queryResult.getTotalCount());
	...
	public void getRoleNameList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		roleNameListView.setTotalRecord(roleNameList.size());
