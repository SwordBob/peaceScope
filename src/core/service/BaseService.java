...
public class BaseService<E> implements Service<E> {
	...
	public List<E> queryByLikeProerties(String propName, Object propValue) {
		return dao.queryByLikeProerties(propName, propValue);
	}
	...
	@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
	public Integer doCount(BaseParameter parameter) {
	...
	@Transactional(readOnly = true, propagation = Propagation.REQUIRED)
	public QueryResult<E> doQueryIncludeDate(BaseParameter parameter){
		return dao.doPaginationQueryDate(parameter,true);
