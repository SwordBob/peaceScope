...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${contextPath}/static/css/p2p-style.css"  />
	    ...
	    <script type="text/javascript">
	        ...
	        Ext.Loader.setPath('p2p.app', '${contextPath}/static/ext/examples/portal');//自动加载p2p.app开头的包文件
	    </script>
